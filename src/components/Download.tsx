              ...
              <div>
                ...
                <div className="flex flex-row mt-5">
                  <Button className="grow basis-0">
                    <a href="https://github.com/ScreenExtend/ScreenExtend/releases/download/app-v0.1.1/ScreenExtend_0.1.1_x86-setup.exe" target="_blank">
                      32-bit EXE
                    </a>
                  </Button>
                  <div className="grow-0 w-3"></div>
                  <Button className="grow basis-0">
                    <a href="https://github.com/ScreenExtend/ScreenExtend/releases/download/app-v0.1.1/ScreenExtend_0.1.1_x64-setup.exe" target="_blank">
                      64-bit EXE
                    </a>
                  </Button>
                  {/* <div className="grow-0 w-3"></div>
